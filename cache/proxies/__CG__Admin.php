 ...
 */
class Admin extends \Admin implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Admin' . "\0" . 'id', '' . "\0" . 'Admin' . "\0" . 'nom', '' . "\0" . 'Admin' . "\0" . 'prenom', '' . "\0" . 'Admin' . "\0" . 'adresse', '' . "\0" . 'Admin' . "\0" . 'telephone', '' . "\0" . 'Admin' . "\0" . 'email', '' . "\0" . 'Admin' . "\0" . 'motPasse', '' . "\0" . 'Admin' . "\0" . 'responsable', '' . "\0" . 'Admin' . "\0" . 'departement'];
        }
