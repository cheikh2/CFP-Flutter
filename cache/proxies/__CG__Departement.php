 ...
 */
class Departement extends \Departement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Departement' . "\0" . 'id', '' . "\0" . 'Departement' . "\0" . 'nom', '' . "\0" . 'Departement' . "\0" . 'id_responsable', '' . "\0" . 'Departement' . "\0" . 'formation', '' . "\0" . 'Departement' . "\0" . 'admin'];
        }
    ...
    public function setIdResponsable($id_responsable)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdResponsable', [$id_responsable]);

        return parent::setIdResponsable($id_responsable);
    }
