...
class Profil extends \Profil implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Profil' . "\0" . 'id', '' . "\0" . 'Profil' . "\0" . 'nom', '' . "\0" . 'Profil' . "\0" . 'candidat'];
        }
    ...
    public function setDate($longitude)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDate', [$longitude]);

        return parent::setDate($longitude);
    }
