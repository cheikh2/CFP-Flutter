 ...
 */
class Responsable extends \Responsable implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Responsable' . "\0" . 'id', '' . "\0" . 'Responsable' . "\0" . 'nom', '' . "\0" . 'Responsable' . "\0" . 'prenom', '' . "\0" . 'Responsable' . "\0" . 'adresse', '' . "\0" . 'Responsable' . "\0" . 'telephone', '' . "\0" . 'Responsable' . "\0" . 'email', '' . "\0" . 'Responsable' . "\0" . 'motPasse', '' . "\0" . 'Responsable' . "\0" . 'admin'];
        }
